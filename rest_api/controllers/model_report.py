...
#           ...
# OUT data:
OUT_report_call_method_SUCCESS_CODE = 200        # editable
...
class ControllerREST(http.Controller):
    ...
    @check_permissions
    def api_report_method_PUT(self, method, **kw):
        return wrap_report_call_method(method=method, success_code=OUT_report_call_method_SUCCESS_CODE)
